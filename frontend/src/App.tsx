...
import { SpaceChatPage } from './features/chat/SpaceChatPage'
  ...
  return (
    <WikiShell>
      <Routes>
        ...
        <Route path="/chat" element={canUseChat ? <SpaceChatPage /> : <Navigate to="/login" replace />} />
