  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        ...
        {/*
          Rows wrap rather than overflow: on a phone the dialog is far narrower than the intrinsic
          width of the name column plus the action cluster. Rename gets its own full width line so
          the field is never squeezed to a fixed 160px inside a ~260px dialog.
        */}
        {assets.map((asset) => (
          <div key={asset.name} className="flex flex-wrap items-center gap-3 rounded-2xl border border-surface-border bg-surface-alt/60 px-4 py-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                ...
                aria-expanded={renameTarget === asset.name}
              >
                <Pencil size={16} />
              </button>
              <button
            ...
            {renameTarget === asset.name ? (
              <div className="flex w-full flex-wrap items-center gap-2">
                ...
                <button type="button" className="action-button-secondary" onClick={() => setRenameTarget(null)}>
                  Cancel
                </button>
              </div>
            ) : null}
